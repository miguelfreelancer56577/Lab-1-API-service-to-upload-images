...
public class JwtComponent {
	...
	@Value("${app.config.image.security.secret.key}")
	private String secretKey;
	@Value("${app.config.image.security.id}")
	private String securityId;
	@Value("${app.config.image.security.expiration.time}")
	private Integer expirationTime;
	@Value("${app.config.image.security.refresh.expiration.time}")
